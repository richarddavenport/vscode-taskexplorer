...
export default class IgnoreDecorationProvider implements DecorationProvider
{
    ...
    private checkIgnoreSoon(): void
    {
        ...
        const ignored = false;//this.repository.statusIgnored;
        const external = false;//this.repository.statusExternal;
