import { DecorationData, DecorationProvider, Disposable, Event, EventEmitter, Uri, window } from 'vscode';

export default class SvnDecorationProvider implements DecorationProvider
{
    private readonly _onDidChangeDecorations = new EventEmitter<Uri[]>();
    public readonly onDidChangeDecorations: Event<Uri[]> = this._onDidChangeDecorations.event;
...
//
    ...
    private collectDecorationData(group: ISvnResourceGroup, bucket: Map<string, DecorationData>): void
    {
